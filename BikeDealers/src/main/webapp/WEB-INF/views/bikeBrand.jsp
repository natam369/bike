...
body {
	background-image:
		url('https://i.pinimg.com/originals/a2/38/3c/a2383cfdf59c9e6c685b0360191001ab.jpg');
...
<body>
	<div class="row">
		...
		<div class="col-md-4">
			...
			<div class="container">
				<form action="/addBikesToBrand" method="post"
					...
					<div class="form-group">
						...
						<textarea rows="2" cols="20" id="bikeName" name="bikeName"></textarea>
					</div>
					<div class="form-group">
						<label for="bikePrice">Bike Price :</label> <input type="number"
							class="form-control item" name="bikePrice" id="bikePrice">
					</div>
